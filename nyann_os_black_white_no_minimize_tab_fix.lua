...
-- ... (Code phía dưới giữ nguyên)
	...
	function Window:MakeTab(paste, Configs)
		...
		local TabSelect = Make("Button", MainScroll, {
			...
			BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		})Make("Corner", TabSelect, UDim.new(0, 14))
		...
		local LabelTitle = InsertTheme(Create("TextLabel", TabSelect, {
			...
			Font = Enum.Font.GothamMedium,
			Text = TName,
			TextColor3 = (FirstTab and Color3.fromRGB(255, 255, 255)) or Color3.fromRGB(165, 165, 165),
			TextSize = 13,
		...
		local LabelIcon = InsertTheme(Create("ImageLabel", TabSelect, {
			...
			Image = TIcon or "",
			BackgroundTransparency = 1,
			ImageColor3 = (FirstTab and Color3.fromRGB(255, 255, 255)) or Color3.fromRGB(165, 165, 165),
			ImageTransparency = 0
		}), "Text")
		...
		local function Tabs()
			...
			CreateTween({LabelIcon, "ImageColor3", Color3.fromRGB(255, 255, 255), 0.2})
		...
		function Tab:Disable()
			...
			CreateTween({LabelTitle, "TextTransparency", 0, 0.2})
			CreateTween({LabelTitle, "TextColor3", Color3.fromRGB(165, 165, 165), 0.2})
			CreateTween({TabSelect, "BackgroundColor3", Color3.fromRGB(0, 0, 0), 0.2})
			CreateTween({LabelIcon, "ImageColor3", Color3.fromRGB(165, 165, 165), 0.2})
			CreateTween({LabelIcon, "ImageTransparency", 0, 0.2})
